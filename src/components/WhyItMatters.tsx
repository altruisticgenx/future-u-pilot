...
const points = [
  {
    icon: AlertTriangle,
    label: "Problem",
    text: "AI systems lack transparency; infrastructure isn't future-ready.",
  ...
  },
  {
    icon: TrendingDown,
    label: "Impact",
    text: "Stalled projects, compliance issues, and security risks.",
    color: "text-red-500",
    bg: "bg-red-500/10",
  },
  {
    icon: CheckCircle2,
    label: "Solution",
    text: "Connect technology, policy, and implementation—responsibly.",
    color: "text-primary",
    bg: "bg-primary/10",
  },
];
