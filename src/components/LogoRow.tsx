          ...
          <div className="flex flex-wrap justify-center items-center gap-12">
            {logos.map((logo, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`${logo.width} h-12 rounded-lg bg-muted/50 border border-border/50 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-300`}
              >
