    ...
    <section className="py-20 relative overflow-hidden" id="ai-showcase">
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        >
          ...
          <p className="text-foreground font-semibold max-w-2xl mx-auto">
            Experience our AI capabilities firsthand. Analyze policies for compliance, security, and quantum readiness.
          </p>
        </motion.div>
              ...
              {policyAnalysis && (
                ...
                >
                  ...
                  <div className="prose prose-sm dark:prose-invert max-w-none">
                    <pre className="whitespace-pre-wrap text-sm font-medium">{policyAnalysis}</pre>
                  </div>
                </motion.div>
              )}
            </CardContent>
